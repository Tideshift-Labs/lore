...
$savedEnv = @{}
foreach ($key in @('LORE_TEST_PG_URL', 'LORE_TEST_S3_ENDPOINT', 'LORE_TEST_S3_REGION', 'LORE_TEST_CLEAN_INIT_CA_PATH', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY', 'AWS_EC2_METADATA_DISABLED')) {
