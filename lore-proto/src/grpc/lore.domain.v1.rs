...
pub struct DomainOperationProofNamespaceStateGetRequestV1 {
    #[prost(uint32, tag = "1")]
...
impl ::prost::Name for DomainOperationProofNamespaceStateGetRequestV1 {
    const NAME: &'static str = "DomainOperationProofNamespaceStateGetRequestV1";
    const PACKAGE: &'static str = "lore.domain.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "lore.domain.v1.DomainOperationProofNamespaceStateGetRequestV1".into()
    }
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DomainOperationProofNamespaceStateGetResponseV1 {
    #[prost(enumeration = "ProofNamespaceStateStatus", tag = "1")]
    pub status: i32,
    #[prost(uint64, optional, tag = "2")]
    pub quota_revision: ::core::option::Option<u64>,
    #[prost(uint64, optional, tag = "3")]
    pub final_high_water: ::core::option::Option<u64>,
    #[prost(bytes = "bytes", optional, tag = "4")]
    pub final_range_set_digest: ::core::option::Option<::prost::bytes::Bytes>,
}
impl ::prost::Name for DomainOperationProofNamespaceStateGetResponseV1 {
    const NAME: &'static str = "DomainOperationProofNamespaceStateGetResponseV1";
    const PACKAGE: &'static str = "lore.domain.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "lore.domain.v1.DomainOperationProofNamespaceStateGetResponseV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/lore.domain.v1.DomainOperationProofNamespaceStateGetResponseV1".into()
    }
...
pub enum ProofNamespaceStateStatus {
    Unspecified = 0,
    MatchedQuiescent = 1,
    MatchedNotQuiescent = 2,
    Absent = 3,
    Mismatch = 4,
}
impl ProofNamespaceStateStatus {
...
pub mod domain_operation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// FORK-LOCAL (Tideshift, CR-029): authenticated org-bound, read-only snapshot.
        /// Preserve /lore.domain.v1.DomainOperationService/DomainOperationProofNamespaceStateGet
        /// and its ratified field tags during upstream reconciliation.
        pub async fn domain_operation_proof_namespace_state_get(
            &mut self,
            request: impl tonic::IntoRequest<
                super::DomainOperationProofNamespaceStateGetRequestV1,
            >,
        ) -> std::result::Result<
            tonic::Response<super::DomainOperationProofNamespaceStateGetResponseV1>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "lore.domain.v1.DomainOperationService",
                        "DomainOperationProofNamespaceStateGet",
                    ),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/lore.domain.v1.DomainOperationService/DomainOperationProofNamespaceStateGet" => {
                    #[allow(non_camel_case_types)]
                    struct DomainOperationProofNamespaceStateGetSvc<
                        T: DomainOperationService,
                    >(
                        pub Arc<T>,
                    );
                    ...
                    > tonic::server::UnaryService<
                        super::DomainOperationProofNamespaceStateGetRequestV1,
                    > for DomainOperationProofNamespaceStateGetSvc<T> {
                        type Response = super::DomainOperationProofNamespaceStateGetResponseV1;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as DomainOperationService>::domain_operation_proof_namespace_state_get(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DomainOperationProofNamespaceStateGetSvc(inner);
                        let codec = crate::DomainOperationV2StrictCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
